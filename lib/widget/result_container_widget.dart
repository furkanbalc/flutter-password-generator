    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 21), child: Divider(color: Colors.white)),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: widget.child),
          const Padding(padding: EdgeInsets.symmetric(horizontal: 13), child: Divider(color: Colors.white)),
